...
const deployMarketPreDeployHelper: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
  ...
  await deploy("MarketPreDeployHelper", {
    from: deployer,
    args: [
...
deployMarketPreDeployHelper.tags = ['MarketPreDeployHelper'];

export default deployMarketPreDeployHelper;
