...
import {IERC20, IWrapped1155Factory} from "./Interfaces.sol";

contract WrappedERC20Factory {
    IWrapped1155Factory public immutable wrapped1155Factory; // Address of the Wrapped1155Factory implementation.
    ...
    bytes public constant TOKEN_DATA =
     ...
     */
    constructor(IWrapped1155Factory _wrapped1155Factory) {
    ...
    function createWrappedToken(address multiToken, uint256 tokenId) external returns (IERC20) {
        IERC20 erc20 = wrapped1155Factory.requireWrapped1155(multiToken, tokenId, TOKEN_DATA);
