...
2. Ensure user has:
   - Connected wallet.
   - Sufficient collateral balance (the market’s collateral token — e.g. sDAI or s-gCRC on Gnosis; see [Collateral profiles](../../../docs/developers/guides/collateral-profiles.mdx)).
