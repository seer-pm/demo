...
import { assertObjectMatches, MOCK_EVENT, POSITION_FIXTURE, USDC_WETH_POOL_ID } from './constants'
...
describe('handleTransfer', () => {
  ...
  test('success - updates position owner', () => {
    ...
    position.pool = USDC_WETH_POOL_ID
    position.tickLower = BigInt.fromI32(-60)
    position.tickUpper = BigInt.fromI32(60)
    position.liquidity = BigInt.fromI32(1000)
  ...
  test('skips token ids without an indexed position', () => {
