...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: "@seer-pm/sdk/sign-in", replacement: path.resolve(seerPmSdkSrc, "sign-in.ts") },
      ...
      {
        find: "@seer-pm/discussions",
        replacement: path.resolve(__dirname, "../packages/seer-pm-discussions/src/index.ts"),
      },
