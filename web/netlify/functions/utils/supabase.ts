...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      pnl_market_leaderboard: {
        Row: {
          address: string;
          capital_deployed: number;
          cashflow_through_ts: number;
          chain_id: number;
          collateral_price_usd: number;
          lp_collateral_net_out: number;
          market_id: string;
          p2p_outcome_net_in: number;
          period: string;
          pnl: number;
          pnl_usd: number;
          router_primary_cum_end: number;
          router_primary_cum_start: number;
          router_primary_split_gross: number;
          trading_collateral_net_out: number;
          traded: boolean;
          updated_at: string;
          value_end: number;
          value_end_mtm: number;
          value_start: number;
          value_start_mtm: number;
          volume: number;
          volume_usd: number;
          window_end: number;
          window_start: number;
      ...
      pnl_leaderboard_refresh_cursor: {
        Row: {
          app_id: string;
          chain_id: number;
          id: string;
