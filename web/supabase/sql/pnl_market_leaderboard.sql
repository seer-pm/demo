...
-- Rotation cursor for the per-market refresh (one row, id='default').
-- Cursor is (chain_id, address) rather than (app_id, chain_id): there is one job per chain now,
-- and it walks wallets.
