...
CREATE TABLE IF NOT EXISTS public.pnl_leaderboard (
  ...
  -- Gross swap notional in primary collateral (flat) or parent-outcome × settlement (conditional).
...
ALTER TABLE public.pnl_leaderboard ADD COLUMN IF NOT EXISTS capital_deployed numeric NOT NULL DEFAULT 0;
...
ALTER TABLE public.pnl_leaderboard ADD COLUMN IF NOT EXISTS scored_market_count integer NOT NULL DEFAULT 0;
ALTER TABLE public.pnl_leaderboard ADD COLUMN IF NOT EXISTS winning_market_count integer NOT NULL DEFAULT 0;
