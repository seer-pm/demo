...
export type QuestionFragment = { __typename?: 'Question', id: string, index: number, arbitrator: `0x${string}`, opening_ts: string, timeout: string, finalize_ts: string, is_pending_arbitration: boolean, best_answer: `0x${string}`, bond: string, min_bond: string };

export type MarketFragment = { __typename?: 'Market', id: string, type: MarketType, marketName: string, outcomes: Array<string>, wrappedTokens: Array<`0x${string}`>, collateralToken: `0x${string}`, collateralToken1: `0x${string}`, collateralToken2: `0x${string}`, parentOutcome: string, parentCollectionId: `0x${string}`, conditionId: `0x${string}`, questionId: `0x${string}`, templateId: string, hasAnswers: boolean, questionsInArbitration: string, openingTs: string, finalizeTs: string, encodedQuestions: Array<string>, lowerBound: string, upperBound: string, payoutReported: boolean, payoutNumerators: Array<string>, factory: `0x${string}`, creator: `0x${string}`, outcomesSupply: string, blockTimestamp: string, transactionHash: `0x${string}`, parentMarket?: { __typename?: 'Market', id: string, payoutReported: boolean, conditionId: `0x${string}`, payoutNumerators: Array<string> } | null, questions: Array<{ __typename?: 'MarketQuestion', question: { __typename?: 'Question', id: string, arbitrator: `0x${string}`, opening_ts: string, timeout: string, finalize_ts: string, is_pending_arbitration: boolean, best_answer: `0x${string}`, bond: string, min_bond: string, index: number }, baseQuestion: { __typename?: 'Question', id: string } }> };
...
export type GetMarketQuery = { __typename?: 'Query', market?: { __typename?: 'Market', id: string, type: MarketType, marketName: string, outcomes: Array<string>, wrappedTokens: Array<`0x${string}`>, collateralToken: `0x${string}`, collateralToken1: `0x${string}`, collateralToken2: `0x${string}`, parentOutcome: string, parentCollectionId: `0x${string}`, conditionId: `0x${string}`, questionId: `0x${string}`, templateId: string, hasAnswers: boolean, questionsInArbitration: string, openingTs: string, finalizeTs: string, encodedQuestions: Array<string>, lowerBound: string, upperBound: string, payoutReported: boolean, payoutNumerators: Array<string>, factory: `0x${string}`, creator: `0x${string}`, outcomesSupply: string, blockTimestamp: string, transactionHash: `0x${string}`, parentMarket?: { __typename?: 'Market', id: string, payoutReported: boolean, conditionId: `0x${string}`, payoutNumerators: Array<string> } | null, questions: Array<{ __typename?: 'MarketQuestion', question: { __typename?: 'Question', id: string, arbitrator: `0x${string}`, opening_ts: string, timeout: string, finalize_ts: string, is_pending_arbitration: boolean, best_answer: `0x${string}`, bond: string, min_bond: string, index: number }, baseQuestion: { __typename?: 'Question', id: string } }> } | null };
...
export type GetConditionalEventsQuery = { __typename?: 'Query', conditionalEvents: Array<{ __typename?: 'ConditionalEvent', id: `0x${string}`, accountId: `0x${string}`, type: string, amount: string, blockNumber: string, collateral: `0x${string}`, transactionHash: `0x${string}`, market: { __typename?: 'Market', id: string, marketName: string } }> };
...
export type GetCurateMetadataQuery = { __typename?: 'Query', curateMetadata?: { __typename?: 'CurateMetadata', registrationMetaEvidenceURI: string } | null };
...
export type GetArbitratorMetadataQuery = { __typename?: 'Query', arbitratorMetadata?: { __typename?: 'ArbitratorMetadata', registrationMetaEvidenceURI: string } | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetMarkets(variables?: GetMarketsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetMarketsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMarketsQuery>(GetMarketsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetMarkets', 'query', variables);
    },
    GetMarket(variables: GetMarketQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetMarketQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMarketQuery>(GetMarketDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetMarket', 'query', variables);
    },
    GetConditionalEvents(variables?: GetConditionalEventsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetConditionalEventsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetConditionalEventsQuery>(GetConditionalEventsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetConditionalEvents', 'query', variables);
    },
    GetCurateMetadata(variables: GetCurateMetadataQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetCurateMetadataQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetCurateMetadataQuery>(GetCurateMetadataDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetCurateMetadata', 'query', variables);
    },
    GetArbitratorMetadata(variables: GetArbitratorMetadataQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetArbitratorMetadataQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetArbitratorMetadataQuery>(GetArbitratorMetadataDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetArbitratorMetadata', 'query', variables);
    }
  };
}
