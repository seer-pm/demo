...
export type GetImagesQuery = { __typename?: 'Query', litems: Array<{ __typename?: 'LItem', itemID: `0x${string}`, status: Status, registryAddress: `0x${string}`, data: string, latestRequester: `0x${string}`, disputed: boolean, latestRequestSubmissionTime: string, metadata?: { __typename?: 'LItemMetadata', props: Array<{ __typename?: 'ItemProp', value?: string | null, description: string, label: string }> } | null, requests: Array<{ __typename?: 'LRequest', requestType: Status, resolved: boolean }> }> };
