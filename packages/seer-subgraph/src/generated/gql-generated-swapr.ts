...
export type GetPoolsQuery = { __typename?: 'Query', pools: Array<{ __typename: 'Pool', id: string, fee: string, liquidity: string, tickSpacing: string, sqrtPrice: string, tick: string, token0Price: string, token1Price: string, volumeToken0: string, volumeToken1: string, volumeUSD: string, txCount: string, totalValueLockedToken0: string, totalValueLockedToken1: string, totalValueLockedUSD: string, totalValueLockedUSDUntracked: string, untrackedVolumeUSD: string, feesUSD: string, token0: { __typename: 'Token', id: string, symbol: string, name: string, decimals: string }, token1: { __typename: 'Token', id: string, symbol: string, name: string, decimals: string } }> };
...
export type GetEternalFarmingsQuery = { __typename?: 'Query', eternalFarmings: Array<{ __typename?: 'EternalFarming', id: string, pool: `0x${string}`, rewardToken: `0x${string}`, bonusRewardToken: `0x${string}`, reward: string, rewardRate: string, startTime: string, endTime: string }> };
...
export type GetDepositsQuery = { __typename?: 'Query', deposits: Array<{ __typename?: 'Deposit', id: string, owner: `0x${string}`, pool: `0x${string}`, limitFarming?: `0x${string}` | null, eternalFarming?: `0x${string}` | null, onFarmingCenter: boolean }> };
...
export type GetPoolHourDatasQuery = { __typename?: 'Query', poolHourDatas: Array<{ __typename?: 'PoolHourData', token0Price: string, token1Price: string, periodStartUnix: number, sqrtPrice: string, liquidity: string, pool: { __typename?: 'Pool', id: string, liquidity: string, token0: { __typename?: 'Token', id: string, name: string }, token1: { __typename?: 'Token', id: string, name: string } } }> };
...
export type GetSwapsQuery = { __typename?: 'Query', swaps: Array<{ __typename?: 'Swap', id: string, sender: `0x${string}`, recipient: `0x${string}`, amount0: string, amount1: string, timestamp: string, tick: string, token0: { __typename?: 'Token', id: string, symbol: string, decimals: string }, token1: { __typename?: 'Token', id: string, symbol: string, decimals: string }, transaction: { __typename?: 'Transaction', id: string, blockNumber: string }, pool: { __typename?: 'Pool', id: string, liquidity: string, token0: { __typename?: 'Token', id: string, name: string }, token1: { __typename?: 'Token', id: string, name: string } } }> };
...
export type GetMintsQuery = { __typename?: 'Query', mints: Array<{ __typename?: 'Mint', id: string, owner: `0x${string}`, amount0: string, amount1: string, timestamp: string, token0: { __typename?: 'Token', id: string, symbol: string, decimals: string }, token1: { __typename?: 'Token', id: string, symbol: string, decimals: string }, transaction: { __typename?: 'Transaction', id: string, blockNumber: string } }> };
...
export type GetBurnsQuery = { __typename?: 'Query', burns: Array<{ __typename?: 'Burn', id: string, owner?: `0x${string}` | null, amount0: string, amount1: string, timestamp: string, token0: { __typename?: 'Token', id: string, symbol: string, decimals: string }, token1: { __typename?: 'Token', id: string, symbol: string, decimals: string }, transaction: { __typename?: 'Transaction', id: string, blockNumber: string } }> };
...
export type GetTicksQuery = { __typename?: 'Query', ticks: Array<{ __typename?: 'Tick', tickIdx: string, liquidityNet: string }> };
...
export type GetPositionsQuery = { __typename?: 'Query', positions: Array<{ __typename?: 'Position', id: string, liquidity: string, tickLower: { __typename?: 'Tick', tickIdx: string }, tickUpper: { __typename?: 'Tick', tickIdx: string }, pool: { __typename?: 'Pool', liquidity: string, tick: string } }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    GetEternalFarmings(variables?: GetEternalFarmingsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetEternalFarmingsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetEternalFarmingsQuery>(GetEternalFarmingsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetEternalFarmings', 'query', variables);
    },
    GetDeposits(variables?: GetDepositsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetDepositsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetDepositsQuery>(GetDepositsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetDeposits', 'query', variables);
    },
    GetPoolHourDatas(variables?: GetPoolHourDatasQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetPoolHourDatasQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetPoolHourDatasQuery>(GetPoolHourDatasDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetPoolHourDatas', 'query', variables);
    },
    GetSwaps(variables?: GetSwapsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetSwapsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetSwapsQuery>(GetSwapsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetSwaps', 'query', variables);
    },
    GetMints(variables?: GetMintsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetMintsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMintsQuery>(GetMintsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetMints', 'query', variables);
    },
    GetBurns(variables?: GetBurnsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetBurnsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetBurnsQuery>(GetBurnsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetBurns', 'query', variables);
    },
    GetTicks(variables?: GetTicksQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetTicksQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetTicksQuery>(GetTicksDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetTicks', 'query', variables);
    },
    GetPositions(variables?: GetPositionsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetPositionsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetPositionsQuery>(GetPositionsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetPositions', 'query', variables);
    }
  };
}
