...
export type GetPoolsQuery = { __typename?: 'Query', pools: Array<{ __typename: 'Pool', id: string, feeTier: string, liquidity: string, sqrtPrice: string, tick?: string | null, token0Price: string, token1Price: string, volumeToken0: string, volumeToken1: string, volumeUSD: string, txCount: string, totalValueLockedToken0: string, totalValueLockedToken1: string, totalValueLockedUSD: string, totalValueLockedUSDUntracked: string, untrackedVolumeUSD: string, feesUSD: string, token0: { __typename: 'Token', id: string, symbol: string, name: string, decimals: string }, token1: { __typename: 'Token', id: string, symbol: string, name: string, decimals: string } }> };
