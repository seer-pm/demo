...
export type ClaimsQueryQuery = { __typename?: 'Query', claims: Array<{ __typename?: 'Claim', question: { __typename?: 'Question', id: string } }> };
...
export type UserActionsQueryQuery = { __typename?: 'Query', userActions: Array<{ __typename?: 'UserAction', question?: { __typename?: 'Question', questionId: `0x${string}` } | null }> };
...
export type QuestionsQueryQuery = { __typename?: 'Query', questions: Array<{ __typename?: 'Question', questionId: `0x${string}`, historyHash?: `0x${string}` | null, currentAnswer?: `0x${string}` | null, bounty: string, responses?: Array<{ __typename?: 'Response', commitmentId?: `0x${string}` | null, answer?: `0x${string}` | null, user: `0x${string}`, bond: string, historyHash: `0x${string}` }> | null }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ClaimsQuery(variables: ClaimsQueryQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ClaimsQueryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ClaimsQueryQuery>(ClaimsQueryDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'ClaimsQuery', 'query', variables);
    },
    UserActionsQuery(variables: UserActionsQueryQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UserActionsQueryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<UserActionsQueryQuery>(UserActionsQueryDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UserActionsQuery', 'query', variables);
    },
    QuestionsQuery(variables: QuestionsQueryQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<QuestionsQueryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<QuestionsQueryQuery>(QuestionsQueryDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'QuestionsQuery', 'query', variables);
    }
  };
}
