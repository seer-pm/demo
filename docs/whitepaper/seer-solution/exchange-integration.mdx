...
In order to solve the issue of split liquidity, aggregators (such as 1inch[^oneinch], Paraswap[^paraswap] or Cowswap[^cowswap]) allowing users to get the best price when buying/selling a position could be used by end user frontends.
...
[^gnosis-cte]: [Conditional Tokens Explorer](https://cte.gnosis.io) — Gnosis
[^oneinch]: [1inch Network](https://1inch.io)
[^paraswap]: [ParaSwap](https://www.paraswap.io)
[^cowswap]: [CoW Protocol](https://cow.fi)
