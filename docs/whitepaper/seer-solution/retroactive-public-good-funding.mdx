...
---
Without a leading entity nor a prior group of token holders, we need to find other ways to incentivize contributions. To solve this problem, Seer will use retroactive public good funding[^retropgf]:
...
[^retropgf]: [Retroactive Public Goods Funding](https://medium.com/ethereum-optimism/retroactive-public-goods-funding-33c9b7d00f0c) — Optimism (2021)
