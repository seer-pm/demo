...
title: "AI Markets"
---
There is already an experiment using AI agents[^omen] to participate in prediction markets. This is quite an interesting initial work, but we believe the real power of AI agent markets lies in computer speed (i.e. where humans can’t participate anyways) markets used by algorithms.
