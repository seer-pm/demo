...
A 0-100 rating of how a wallet traded the markets in a period, shown on the [leaderboard](/app/leaderboard). It is a weighted mean of five components — returns (25%), profit factor (25%), hit rate (20%), loss burn (15%) and breadth (15%) — so it reflects *how* a profit was made, not only how large it was. Scores map to five tiers: Elite (85+), Great (70+), Good (55+), Average (40+) and Weak (below 40).
