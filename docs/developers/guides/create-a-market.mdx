...
The **@seer-pm/sdk** provides `getCreateMarketParams`, `getCreateMarketExecution`, and `MarketTypes`. Use your viem clients to send the transaction. See [Viem setup](/developers/configuration#dependencies) for installation.
