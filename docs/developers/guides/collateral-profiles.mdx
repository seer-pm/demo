---
title: "Collateral profiles (multi-primary)"
---
...
- **Conditional markets:** Collateral for the child is the parent’s **outcome token**, not a chain profile (unchanged — see [Conditional market](/developers/guides/conditional-markets)).
